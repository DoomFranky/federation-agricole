...
public class MemberInscription {
    private String id;
    ...
    public MemberInscription() {}

    public MemberInscription(String firstName, String lastName, LocalDate birthDate, String gender,
            String address, String profession, String phoneNumber, String email,
            List<String> refereeIds, Boolean registrationFeePaid, Boolean membershipDuesPaid) {
